...
到这里，Workflow 的核心节点你都见过了：条件分支、迭代、参数提取、工具调用、HTTP 请求。这些能力是通用的，后面做周报、做内容、做预警系统全都用得上。

不过客服场景还差一块：多轮对话的记忆。客户说了预算，下一句 AI 就忘了。下一章用 Chatflow 补上。
